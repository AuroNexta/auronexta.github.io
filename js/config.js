/* ================================================================
   AURONEXTA — SITE_JSON
   All configuration. Edit paths, speeds, colors, GitHub data repo.
================================================================ */
const SITE_JSON = {
  "_doc": "Central config. See README.md for GitHub Pages deploy steps.",

  /* ═══════════════════════════════════════════════════════════════
     SECTION A — GITHUB DATA LOADER (COMMENTED OUT)
     Uncomment this block + set your repo credentials when ready.
     Comment out SECTION B (dummy data) below.
     ═══════════════════════════════════════════════════════════════
  "github": {
    "owner":  "YOUR_USERNAME",          ← your GitHub username
    "repo":   "YOUR_DATA_REPO",         ← repo holding projects/ & web/profiles/
    "branch": "main",
    "projectsPath":  "projects",        ← projects/ClassName/ProjectName/
    "profilePath":   "web/profiles"     ← web/profiles/
  },
  */
  "github": {
  ...
  /* ═══════════════════════════════════════════════════════════════
     ...
     Comment out everything from here to the closing "demoTestimonials"
     when you uncomment SECTION A above.
     ═══════════════════════════════════════════════════════════════ */
  ...
  /* ── Demo Projects ──
     GitHub path format:
       projects/CLASS_NAME/Project_Name/
         whitepaper.md          ← content (REQUIRED)
         whitepaper_banner.png  ← hero image (OPTIONAL)
         whitepaper_poster.png  ← thumbnail  (OPTIONAL)
  */
  "demoProjects": [
